        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionPlan = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    SubscriptionExpiry = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastLogin = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RazorpayCustomerId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedTools", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SavedTools_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToolUsages_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancelAtCycleEnd = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentOrders_CreatedAt",
                table: "PaymentOrders",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedTools_UserId",
                table: "SavedTools",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ToolUsages_ToolName",
                table: "ToolUsages",
                column: "ToolName");

            migrationBuilder.CreateIndex(
                name: "IX_ToolUsages_UsedAt",
                table: "ToolUsages",
                column: "UsedAt");

            migrationBuilder.CreateIndex(
                name: "IX_ToolUsages_UserId",
                table: "ToolUsages",
                column: "UserId");
